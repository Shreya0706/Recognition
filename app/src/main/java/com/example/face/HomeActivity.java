...
public class HomeActivity extends AppCompatActivity implements SensorEventListener {
                    ...
                    cdt = new CountDownTimer(10000, 1000) {
                        ...
                        public void onFinish() {
                            ...
                            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                startForegroundService(new Intent(HomeActivity.this, com.example.face.PocketService.class));
                            } else {
                                startService(new Intent(HomeActivity.this, com.example.face.PocketService.class));
                            }
                        }
                    }.start();
                    alertDialog.show();
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (mAccel > 0.5) {
                //Toast.makeText(MainActivity.this, "Sensor Run ", Toast.LENGTH_SHORT).show();
//                MediaPlayer mPlayer = MediaPlayer.create(HomeActivity.this, R.raw.siren);
//                mPlayer.start();
                if (mSwitchSet == 1) {
//                    wakeDevice();
                    startActivity(new Intent(HomeActivity.this, EnterPin.class));
