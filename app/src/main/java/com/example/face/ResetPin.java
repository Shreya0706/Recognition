...
import static com.example.face.SetPin.MyPREFERENCES;
import static com.example.face.SetPin.Password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnForgotOldPin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ResetPin.this, com.example.face.ForgotPin.class));
                finish();
            }
        });
